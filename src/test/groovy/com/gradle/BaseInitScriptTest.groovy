...
abstract class BaseInitScriptTest extends Specification {
    ...
    private static List<String> mapEnvVarsToSystemProps(Map<String, String> envVars) {
        def mapping = [
            ...
            DEVELOCITY_INJECTION_LOGGING_ENABLED      : "develocity.injection.logging-enabled",
    ...
    static class DvInjectionTestConfig {
        ...
        DvInjectionTestConfig withLoggingDisabled() {
        ...
        Map<String, String> getEnvVars() {
            ...
            if (!loggingEnabled) envVars.put("DEVELOCITY_INJECTION_LOGGING_ENABLED", "false")
            return envVars
        }
    }
